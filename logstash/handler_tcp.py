...
class TCPLogstashHandler(SocketHandler, object):
    ...
    :param check_hostname: Should Hostname be verified in the cerfiticate? Default is True
    """

    def __init__(self, host, port=5959, message_type='logstash', tags=None, fqdn=False, version=0, ssl=True, ssl_verify=True, check_hostname=True, keyfile=None, certfile=None, ca_certs=None):
